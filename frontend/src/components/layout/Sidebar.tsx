...
const NAV = [
  ...
  { href: "/priority",    label: "Collection Priority", icon: "⚡", ready: true },
  { href: "/routes",      label: "Routes",              icon: "🧭", ready: true },
  { href: "/classify",    label: "Waste Classification",icon: "♻️", ready: true },
  { href: "/analytics",   label: "Analytics",           icon: "📈", ready: true },  // <-- CHANGED TO TRUE
  { href: "/alerts",      label: "Alerts",              icon: "🚨", ready: true },  // <-- CHANGED TO TRUE
];
